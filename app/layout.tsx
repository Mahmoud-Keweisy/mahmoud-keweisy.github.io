...
export default function RootLayout({
  ...
  return (
    <html lang="en-GB" className={inter.variable}>
      ...
      <body className="bg-neutral-50 font-sans text-neutral-900 antialiased selection:bg-primary-100 selection:text-primary-800 dark:bg-slate-950 dark:text-neutral-50 dark:selection:bg-primary-700 dark:selection:text-white">
        <a
          href="#main-content"
        ...
        <div className="min-h-dvh pb-[env(safe-area-inset-bottom)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] pt-[env(safe-area-inset-top)]">
          {children}
        </div>
      </body>
    </html>
