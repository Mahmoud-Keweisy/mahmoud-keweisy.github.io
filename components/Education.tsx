  ...
  return (
    <div className="container-responsive">
      ...
      >
        ...
        <p className="section-subheading">Academic journey and coursework</p>
      </motion.div>
            ...
            >
              ...
              {edu.gpa && (
                <div className="mb-3">
                  <span className="text-sm font-medium text-neutral-600 dark:text-neutral-300">
                    GPA: <span className="text-neutral-900 dark:text-neutral-100">{edu.gpa}</span>
                  </span>
                </div>
              )}
              ...
              <div className="mt-auto border-t border-neutral-100 pt-4 dark:border-slate-700">
                <div className="flex items-center text-sm font-medium text-neutral-700 dark:text-neutral-200">
                  ...
                  {edu.end?.toLowerCase() === 'present' ? 'Currently Enrolled' : 'Completed'}
                </div>
              </div>
            </motion.div>
          </motion.div>
