    ...
    const svg = `<svg xmlns='http://www.w3.org/2000/svg' width='384' height='384' viewBox='0 0 384 384'>
      <defs>
        <linearGradient id='g' x1='0' y1='0' x2='1' y2='1'>
          <stop offset='0%' stop-color='#636B73'/>
          <stop offset='100%' stop-color='#283540'/>
        </linearGradient>
      </defs>
      <rect width='100%' height='100%' fill='url(#g)'/>
      <text x='50%' y='50%' dy='.1em' text-anchor='middle' font-family='Inter, Arial, sans-serif' font-size='144' font-weight='700' fill='#F2F2F2'>${initials}</text>
    </svg>`;
