        ...
        createPortal(
          <div className="fixed inset-0 z-[90] md:hidden">
            ...
            <motion.div
              ...
              className="glass-strong absolute right-0 top-0 h-full w-[min(85vw,320px)] overflow-y-auto overscroll-contain rounded-l-2xl rounded-r-none border-r-0 shadow-2xl"
              role="dialog"
              aria-modal="true"
