            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full resize-y rounded-lg border px-4 py-3 transition-colors duration-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-300 ${
              ...
              <input
                type="text"
                {...register('honeypot')}
                style={process.env.NODE_ENV === 'test' ? { display: 'none' } : undefined}
                className={process.env.NODE_ENV === 'test' ? undefined : 'hidden'}
                tabIndex={-1}
                autoComplete="off"
                aria-hidden="true"
              />
